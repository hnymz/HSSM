    ...
    include=[
        {
            ...
            "prior": {
                ...
                "1|subject": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},
                
                "mbased_efficacy_prev": {"name": "Normal", "mu": 0.0, "sigma": 0.5},
                "1|mbased_efficacy_prev": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},
                
                "mbased_reward_prev": {"name": "Normal", "mu": 0.0, "sigma": 0.5},
                "1|mbased_reward_prev": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},

                "mbased_efficacy_prev:mbased_reward_prev": {"name": "Normal", "mu": 0.0, "sigma": 0.5},
                "1|mbased_efficacy_prev:mbased_reward_prev": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},
                
                "Congruency": {"name": "Normal", "mu": 0.0, "sigma": 0.5},
                "1|Congruency": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},
            },
        ...
        },
        {
            "name": "a",
            "prior": {
                "Intercept": {"name": "HalfCauchy", "beta": 0.1},
                "1|subject": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},
                
                "mbased_efficacy_prev": {"name": "Normal", "mu": 0.0, "sigma": 0.2},
                "1|mbased_efficacy_prev": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},
                
                "mbased_reward_prev": {"name": "Normal", "mu": 0.0, "sigma": 0.2},
                "1|mbased_reward_prev": {"name": "Normal", "mu":0.0, "sigma":{"name": "HalfCauchy", "beta": 0.1}},
...
# Save the model
modelObject.to_netcdf('../output/Model4')
