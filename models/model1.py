    ...
    include=[
        {
            ...
            "formula": "v ~ 1 + Congruency + mbased_efficacy_prev * mbased_reward_prev + (1|subject)",
        },
        {
            "name": "a",
            "prior": {
            ...
            "formula": "a ~ 1 + mbased_efficacy_prev * mbased_reward_prev + (1|subject)",
        },
    ],
)
...
# Save the model
modelObject.to_netcdf('../output/Model1')
